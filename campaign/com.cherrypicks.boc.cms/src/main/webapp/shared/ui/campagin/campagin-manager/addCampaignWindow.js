isc.SDynamicForm.create({
    ...
    fields:[
        {name:"langCode", type:"text", width:"*", required:true, optionDataSource:"languageDS", optionCriteria:{searchType:""}, colSpan:4,
                valueField:"code", displayField:"name", pickListWidth:390, pickListHeight:500,defaultValue:"en-US",
                pickListFields:[
      ...
      /*  {name:"startTime",  width:"*", showTitle:false},*/
       ...
       /* {name:"endTime",  width:"*", showTitle:false},*/
        {name:"campaignType", width:"500",colSpan:4,defaultValue:"0" },
        {name:"playType", width:"500", colSpan:4,defaultValue:"0"},
	            	...
	            	isc.confirm("Are you sure save?", function(value) {
	            		if (value) {
			                form.saveData(function (dsResponse, data, dsRequest) {
			                    ...
			                    addCampaignWindow.isValueChanged = false;
			                    addCampaignWindow.hide();
			                    form.successPrompt("Save");
			                });
	            		} else {
	            			form.cancelChanged(addCampaignForm);
	            		}
	            	});
            	}
            }
...
isc.SWindow.create({
    ID:"addCampaignWindow",
    title:"Add Campaign",
    width:800,
    height:400,
    isValueChanged: false,
    items:[addCampaignForm],
	initWidget:function(){
